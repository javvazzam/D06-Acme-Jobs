...
public class AdministratorChallengeCreateService implements AbstractCreateService<Administrator, Challenge> {
	...
	public void validate(final Request<Challenge> request, final Challenge entity, final Errors errors) {
		...
		if (entity.getGoldReward() != null) {
			...
			errors.state(request, isGoldRewardEuro, "goldReward", "administrator.challenge.incorrect-currency");
		} else {
		...
		if (entity.getBronzeReward() != null) {
			...
			errors.state(request, isBronzeRewardEuro, "bronzeReward", "administrator.challenge.incorrect-currency");
		} else {
		...
		if (entity.getSilverReward() != null) {
			...
			errors.state(request, isSilverRewardEuro, "silverReward", "administrator.challenge.incorrect-currency");
		} else {
